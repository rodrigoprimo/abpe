{* $Id: tiki-show_page.tpl 13390 2008-06-30 14:22:48Z nyloth $ *} 
...
{if $page ne 'home_pt' && $page ne 'home_eo' && $page ne 'home_en'}
...
{if $print_page ne 'y'}
	...
	{if $prefs.feature_multilingual == 'y' && $user}
